  ...
  return (
    ...
    <Navbar/>
     ...
     <h2 className=" text-center text-5xl font-bold text-transparent bg-clip-text bg-primary-gradient">
       ...
       <section className=" mt-24 flex flex-col md:flex-row items-center justify-between  bg-primary-gradient w-full md:h-[600px]  p-8 rounded-3xl">
     ...
     <div className="md:w-2/4  text-white mt-8 md:mt-0">
       ...
       <a href="" className="bg-white  text-purple-700 px-6 py-3 rounded-full flex items-center gap-2">
